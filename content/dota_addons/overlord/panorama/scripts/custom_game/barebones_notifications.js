...
function CreateOverlordUI() //inserted lazily here by UncertainCat
{
	var Container = $("#ConditionalHudElements");
	var newpanel = $.CreatePanel( "Panel", Container, "RadiantPanel" );
	newpanel.BLoadLayout("file://{resources}/layout/custom_game/overlord_ui.xml", false,false) ;
	newpanel.AddClass( "OverlordBaseHud");	
}
...
(function () {
  ...
  GameEvents.Subscribe( "create_overlord_ui", CreateOverlordUI );
  GameEvents.SendCustomGameEventToServer( "overlord_loaded_pregame", { "player" :  Game.GetLocalPlayerInfo() } );
})();
